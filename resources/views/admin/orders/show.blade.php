                ...
                <div class="card-body">
                    @foreach($order->items as $item)
                        <div class="d-flex mb-3 align-items-center">
                            <img src="{{ $item->product->image_url ?? asset('images/default-product.png') }}" class="rounded me-3" style="width: 60px; height: 60px; object-fit: cover;">
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-0 text-muted small">No. HP: {{ $order->shipping_phone ?? '-' }}</p>
                </div>
            </div>

          {{-- Bagian Action Card saja --}}
<div class="card shadow-sm border-0 bg-light">
    <div class="card-body">
        <h6 class="fw-bold mb-3">Update Status Order</h6>
        
        {{-- Pastikan nama route ini benar: 'admin.orders.updateStatus' atau 'admin.orders.update-status' --}}
        ...
        @if($order->status == 'cancelled')
            <div class="alert alert-warning mt-3 mb-0 small border-0 shadow-sm">
                <i class="bi bi-info-circle"></i> Pesanan ini berstatus <strong>Cancelled</strong>. Stok telah dikembalikan ke gudang.
            </div>
        @endif
    </div>
</div>
